<?php 
	...
	if (isset($_POST['new_branch_submit'])){
		...
		if (isset($_POST['branch_serial_number'])){$branch_serial_number = $_POST['branch_serial_number'];}
...
<div class="mega_branch_create_user">
	...
	<div class="bg-light text-dark p-4 general_form_width">
		...
		<div class="mbcu_inner d-flex flex-wrap">
			...
			<hr class="w-100">
			<div class="mbcu_submit col-12 mt-4">
				<button onclick="register_branch('<?php echo get_current_user_id();?>')" class="btn btn-success">ثبت نام نمایندگی</button>
			</div>
